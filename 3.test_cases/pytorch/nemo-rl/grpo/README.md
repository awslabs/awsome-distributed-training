...
Multi-node [GRPO](https://arxiv.org/abs/2402.03300) (Group Relative Policy Optimization) training using [NVIDIA NeMo RL](https://github.com/NVIDIA-NeMo/RL) on Amazon EKS. Tested across multiple GPU instance types including P5en (H200), P5 (H100), and G6E (L40S).
...
python3 eval_nemotron_goldilocks.py \
  --model /shared/nvrx-demo/nemotron-phase1-merged \
...
- Pre-built image: `public.ecr.aws/v9l4g5s4/dynamo-combined:latest`
...
Software Bill of Materials is available in the `sbom/` directory:
...
|-------|------|-------------|
| `public.ecr.aws/v9l4g5s4/nemo-rl-workshop:p5en` | 24.4 GB (compressed) | linux/amd64 |
